...
class AnalyticsSettings(BaseSettings):
    ...
    batch_processing_enabled: bool = Field(default=True, env="ANALYTICS_BATCH_PROCESSING")
    export_formats: list = Field(default=["json", "csv", "excel"], env="ANALYTICS_EXPORT_FORMATS")
...
class Settings(BaseSettings):
    ...
    product_service_url: str = Field(default="http://localhost:8002", env="PRODUCT_SERVICE_URL")
    user_service_url: str = Field(default="http://localhost:8006", env="USER_SERVICE_URL")
